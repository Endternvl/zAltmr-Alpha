...
module.exports = {
  ...
  if (!args[0]) return sendError("You Didn't Provide A Github Username!", message.channel)
    
  fetch(`https://api.github.com/users/${args.join('-')}`)
    .then(res => res.json()).then(body => {
      if(body.message) return sendError(`This User | ${args[0]} | Is Not In Github! Please Enter A Valid Username!`, message.channel);
